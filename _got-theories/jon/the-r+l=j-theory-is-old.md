...
{% include defs.md %}
It dates back to **1997**{:ul}. Yes, that's correct, it is not a typo.

Back in 1997, *A Game of Thrones* was the only book that was already released, so the level of 
knowledge readers had was roughly that of season one plus some background information from the book 
